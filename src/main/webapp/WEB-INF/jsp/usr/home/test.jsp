	...
	xhr.onreadystatechange = function() {
		if (this.readyState == 4) {
			...
			for (var i = startPage - 1; i < endPage; i++) {
				...
				var eventTitleElement = document.createElement("td");
				var eventBodyElement = document.createElement("div");

				eventElement.innerHTML = "<tr><td><div class=eventId>" + (i + 1)	+ " </div></td><td><div class=eventTitle" + i + " onclick=showApi(" + i + ") style='cursor: pointer'> " + tourspotSumm	+ " </div></td></tr>"
